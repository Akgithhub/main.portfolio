...
function Myproject() {
  ...
  return (
    <>
      ...
      <div
        id="myprojects"
        className="projects text-white bg-[#000111] flex justify-center lg:justify-start lg:mt-40vh  lg:mb-20vh sm:mt-[30vh] "
      >
              ...
              <motion.h1 {...animations2.h1}>
                {
                  <>
                    ...
                    <h1 className="card-data max-w-[34vw] leading-8 mt-[2vh] font-semibold">
                      ⚡️ Explore the power of AI with Orca.AI, my cutting-edge
                      full-stack chat application! 🌐 Crafted with React for a
                      sleek and interactive frontend, and fortified with a
                      robust backend using Node.js and MongoDB. 🛠️ Leveraging
                      Clerk for secure user authentication and integrating
                      advanced AI capabilities for dynamic conversations. 🧠
                      Seamless navigation powered by React Router DOM and smooth
                      data handling with Axios. Dive in now and experience the
              ...
              <motion.h1 {...animations1.h1}>
                {
                  <>
                    ...
                    <h1 className="card-data max-w-[34vw] leading-8 mt-[2vh] font-semibold">
                      🍔 Introducing Tomato – your ultimate food delivery
                      experience! 🚀 Built with React for a dynamic user
                      interface and powered by a robust backend, DelishDash
                      integrates Stripe for secure payment processing and smooth
                      transactions. 📦 Enjoy seamless ordering and real-time
                      updates with our intuitive admin panel, designed to
                      streamline operations and manage deliveries effortlessly.
                      💼 From delicious meal choices to quick payments,
                      DelishDash makes dining easy and enjoyable. 🍽️🔧
                    </h1>
                    <a href="">
                      <button className="mt-[2vh] bg-[#111827] border-2 border-[#88ab8e] p-4 rounded-2xl text-[#88ab8e] font-medium hover:scale-110 transition-all">
                        Visit Website
